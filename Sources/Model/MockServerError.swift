...
public enum MockServerError: Error {
	...
	public var description: String {
		switch self {
		case .invalidPactJSON: return describing("Pact JSON could not be parsed.")
		case .invalidSocketAddress: return describing("Socket Address is invalid.")
		case .failedToStart: return describing("Could not start.")
		case .failedToWriteFile: return describing("Failed to write Pact contract to file.")
