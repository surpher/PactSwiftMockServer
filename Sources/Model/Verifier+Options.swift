...
public extension Verifier {
	...
	struct Options {
		...
		///   - pactSource: The locations of pacts
...
extension Verifier.Options {

	/// Newline delimited provider verification arguments
	func args() throws -> String {										// swiftlint:disable:this cyclomatic_complexity function_body_length
		...
		// Set the name of the verified provider
